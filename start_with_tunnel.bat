...
:server_ready
echo [CLEANUP] Stopping existing widget processes before relaunching.
...
echo [INFO] Launching the widget and public tunnel.
start "Live Widget" python "%~dp0live_widget.py"
